-- ============================================================
-- Migration 0014: Admin Reset Password Function
-- ============================================================

-- Function to allow the owner to reset a user's password to a default or specified value
-- This is needed because users use fake emails (phone@souqbaghdad.com) and cannot receive reset emails.
