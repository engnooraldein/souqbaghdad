          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            {user?(
              <>
                ...
                <button onClick={() => setView('profile')} className={`flex items-center gap-2 px-3 py-2 rounded-xl text-sm border transition-colors ${view==='profile'?'bg-amber-500/20 border-amber-500/40 text-amber-400':(isDarkMode ? 'bg-gray-800 border-gray-700 text-white hover:bg-gray-700' : 'bg-slate-100 border-slate-200 text-slate-700 hover:bg-slate-200')}`}>
