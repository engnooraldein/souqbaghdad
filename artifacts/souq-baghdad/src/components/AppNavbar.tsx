  ...
  return (
    <nav 
      className={`fixed z-40 backdrop-blur-2xl backdrop-saturate-150 transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] shadow-sm ${
        isCollapsed 
          ? `top-[max(3.2rem,calc(env(safe-area-inset-top)+0.25rem))] left-4 right-auto w-[48px] h-[48px] rounded-full border cursor-pointer overflow-hidden ${isDarkMode ? 'bg-black/60 border-white/10 shadow-lg shadow-black/50' : 'bg-white/70 border-slate-200/60 shadow-lg'}` 
