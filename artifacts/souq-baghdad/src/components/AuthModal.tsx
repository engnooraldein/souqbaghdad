              ...
              <div className="space-y-3">
                ...
                {!isNative && (
                  <button
                    ...
                    className="w-full py-3.5 px-5 bg-white hover:bg-gray-100 text-gray-800 font-bold rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] shadow"
                  >
                ...
                {!isNative && (
                  <button
                    ...
                    className="w-full py-3 px-5 bg-blue-600/10 hover:bg-blue-600/20 text-blue-400 font-bold rounded-2xl flex items-center justify-center gap-2 transition-all active:scale-[0.98] border border-blue-600/20"
                  >
                    <Key className="w-4 h-4" /> دخول بـ Passkey ⚡
                  </button>
                )}
                ...
                {isNative && biometricEnabled && (
                  <button
                    ...
                    className="w-full py-3 px-5 bg-blue-600/10 hover:bg-blue-600/20 text-blue-400 font-bold rounded-2xl flex items-center justify-center gap-2 transition-all active:scale-[0.98] border border-blue-600/20"
                  >
                    <Fingerprint className="w-4 h-4" /> دخول سريع بالبصمة ⚡
                  </button>
                )}
              </div>
            )}
