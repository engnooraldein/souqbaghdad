  ...
  return (
    <motion.div initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 touch-none">
        ...
        <div className="p-4 sm:p-5">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2.5 mb-3.5 pb-3.5 border-b border-gray-800/60">
            <div className="flex-1 min-w-0 space-y-1.5">
              ...
              <h2 className="text-lg sm:text-xl font-extrabold text-white leading-tight line-clamp-2 break-words">{ad.title}</h2>
          ...
          <div className="grid grid-cols-3 gap-2 mb-2.5">
            ...
            <motion.a href={`tel:${ad.phone}`} whileHover={{scale:1.01}} whileTap={{scale:0.99}} className="flex items-center justify-center gap-1 py-2.5 bg-gray-800 text-white font-bold rounded-xl text-xs">
      ...
      <SocialPublishModal
        ...
        item={ad}
        category={ad?.category === 'vehicles' || ad?.category === 'cars' ? 'cars' : 'general'}
        table="ads"
      />
    </motion.div>
  );
