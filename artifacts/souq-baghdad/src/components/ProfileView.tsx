              ...
              <div className={`mt-4 pt-4 border-t ${isDarkMode ? 'border-gray-700' : 'border-slate-100'}`}>
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-lg bg-white flex items-center justify-center shadow-sm shrink-0 border border-gray-200">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-gray-400">
                        {user.email && !user.email.endsWith('@souqbaghdad.com')
                          ? `مرتبط بالبريد (${user.email})`
                          : 'يمكنك الدخول السريع بحساب جوجل'}
                      </p>
                    </div>
                  </div>
                  <button
                    ...
                    className="px-3 py-1.5 bg-white text-gray-800 hover:bg-gray-100 font-bold rounded-xl text-xs flex items-center gap-1.5 shadow border border-gray-200 transition-colors shrink-0"
                  >
                    <span>ربط / تسجيل كـ Google</span>
                  </button>
                </div>
              </div>
